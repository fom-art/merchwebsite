...
<head>
    ...
    <title>ANFO</title>
    <!-- Stylesheets -->
    <link rel="stylesheet" href="styles/galleryPageStyles.css">
    <link rel="stylesheet" media="print" href="styles/galleryPageStylesPrint.css">
...
<header>
    <div class="header-block">
        ...
        <div class="icons-header-row-block">
            <!-- Admin Icon -->
            <?php if (isset($_SESSION['user']['id']) && in_array($_SESSION['user']['id'], Constants::ADMIN_ID_COLLECTION)): ?>
                <div class="icon-block">
                    <a href="phpPages/adminPage.php" id="add-product-button" class="icon-block">
            ...
            <!-- User/Login Icon -->
            <div class="icon-block">
                <a href="<?php echo isset($_SESSION["user"]) ? "phpPages/userPage.php" : "phpPages/signInPage.php"; ?>"
                   class="header-icon">
                    <svg id="log-in-svg">
                        <title>Log in</title>
                        <defs>
            ...
            <!-- Purchase Icon -->
            <div class="icon-block">
                <a href="phpPages/purchasePage.php" class="header-icon">
                    <svg
